  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="字数" prop="zishu">
              <el-input v-model="ruleForm.zishu" 
                placeholder="字数" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="章节数" prop="zhangjieshu">
          <el-input v-model="ruleForm.zhangjieshu" 
              placeholder="章节数" clearable  :readonly="ro.zhangjieshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="章节数" prop="zhangjieshu">
              <el-input v-model="ruleForm.zhangjieshu" 
                placeholder="章节数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" v-if="ruleForm.shangjiariqi" label="上架日期" prop="shangjiariqi">
              <el-input v-model="ruleForm.shangjiariqi" 
                placeholder="上架日期" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="是否完结" prop="shifouwanjie">
          <el-select v-model="ruleForm.shifouwanjie" placeholder="请选择是否完结">
            <el-option
                v-for="(item,index) in shifouwanjieOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="是否完结" prop="shifouwanjie">
	      <el-input v-model="ruleForm.shifouwanjie"
                placeholder="是否完结" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                            </el-row>
